...
public class questão_3_ok {
        public static void main(String[] args) {
            /*(3.)Débora se inscreveu em uma rede social para se manter em contato com seus amigos. A
página de cadastro exigia o preenchimento dos campos de nome e senha, porém a senha
precisa ser forte.
...
*/
            ...
            System.out.println("Digite uma senha que atenda aos seguintes critérios: "+ "\n" +
                    ...
                    "- Contenha no mínimo 1 digito;(número)" + "\n" +
                    "- Contenha no mínimo 1 letra minúscula;" + "\n" +
                    "- Contenha no mínimo 1 letra maiúsculas;" + "\n" +
